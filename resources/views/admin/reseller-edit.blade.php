  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      ...
      <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
          <h1 class="app-page-title mb-0">Update Reseller User</h1>
        </div>
        ...
        <div class="col-12">
          <div class="app-card">
            ...
            <div class="app-card-body">
              <form action="{{ route('reseller.admin-reseller-edit-make') }}" method="post"
                class="settings-form needs-validation" enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="reseller_id" value="{{ $reseller->id }}">
                <input type="hidden" name="reseller_old_logo" value="{{ $reseller->logo }}">
                ...
                <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="email" placeholder="Email"
                        value="{{ old('email', $reseller->email) }}" autocomplete="off" />
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-floating">
                      ...
                      <input type="text" id="input-fname" name="company_name" placeholder="Company Name"
                        value="{{ old('company_name', $reseller->company_name) }}" class="form-control" autocomplete="off">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-floating">
                      <input class="form-control" type="number" id="input-lname" name="profit"
                        placeholder="Profit value" value="{{ old('profit', $reseller->profit) }}">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="url" placeholder="Url" value="{{ old('url', $reseller->company_name) }}">
                      <label for="url">URL</label>
                      <span class="error-message d-none">{{ $errors->first('url') }}</span>
                    </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="row">
                      <div class="col-10">
                        <div class="input-group mb-3">
                          ...
                          <input type="file" class="form-control" name="logo" class='file'/>
                      ...
                      <div class="col-2">
                        <div class="w-100 mb-3">
                          <img
                            src="{{ asset('resellers/logo/'.$reseller->logo) }}"
