  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      ...
      <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
          <h1 class="app-page-title mb-0">Add Admin</h1>
        </div>
        ...
        <div class="col-12">
          <div class="app-card">
            ...
            <div class="app-card-body">
              <form action="{{ route('reseller.admin-admin-add-make') }}" method="post"
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="form-floating">
                      ...
                      <input type="text" id="input-fname" name="full_name" placeholder="Full Name"
                        value="{{ old('full_name') }}" class="form-control" autocomplete="off">
